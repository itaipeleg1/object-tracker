...
if __name__ == "__main__":
    ...
    for video_id in ['MAX_00051','MAX_0010','MAX_0012','MAX_0007','MAX_0008']:
        ...
        output_path = fr"C:\kela\tracker\object-tracker\data\output\{video_id}_tracked_HD5.mp4" # Path to save output video (optional)
